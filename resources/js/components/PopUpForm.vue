<template>
    <div>
        <transition v-if="popUp" name="bounce">
            <div class="h-screen w-full bg-black bg-opacity-60 fixed top-0 left-0 z-30 flex items-center justify-center px-3 py-2 text-white">
