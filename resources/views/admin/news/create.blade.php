            ...
            @csrf
                ...
                <div class="mb-6">
                    ...
                    <textarea
                        ...
                        name="description_en"
                        rows="20"
                        class="bg-gray-50 appearance-none border-2 border-gray-200 @error('description_en') border-red-500 @enderror rounded w-full focus:outline-none focus:bg-white focus:border-blue-400"
                    >
                        {{ old('description_en') }}
                    </textarea>
